...
.DEFAULT_GOAL := help
.PHONY: help sync dev as mock console fraud mock-return gen lint format type test unit integration e2e demo \
...
mock-return: sync ## Run only the mock S-SBC return side (UAS, answers 200 OK on port 5061)
